...
const Modal = ({ category, closeModal }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 backdrop-blur-sm">
            ...
            <div className="relative bg-white rounded-2xl shadow-xl transform transition-all w-11/12 md:w-1/3 p-8 z-10 animate-fadeIn">
                <button
                    onClick={closeModal}
                ...
                <h2 className="text-3xl font-bold text-green-700 mb-6">{category.name}</h2>
